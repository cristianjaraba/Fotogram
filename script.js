...
function openDialog(i) {
    ...
    dialogRef.innerHTML = `
     <header>
        ...
        <footer>
            <button onclick="showPreviousFoto(${i})" id="previous-btn">
            ...
            <p>${myImgs.indexOf(myImgs[i]) + 1}/${myImgs.length}</p>
            <button onclick="showNextFoto(${i})" id="next-btn">
